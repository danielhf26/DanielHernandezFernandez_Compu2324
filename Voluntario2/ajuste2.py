...
### Ajuste
# Hacemos el ajuste lineal (hemos usado la función func que está definida como una función lineal).  
# Obtenemos también el chi^2.
...
plt.ylabel(r'Error relativo',fontsize=25)
