...
file_name = 'C:/fisica_computacional/Repositorios_git/DanielHernandezFernandez_Compu2324/Voluntario1/Datos_lyapunov.txt'
...
data = pd.read_csv(file_name, delimiter=',', names=['dx', 'x'])
print(data)
...
plt.title("Condiciones iniciales: φ=0.2, ψ=0.2, φ'=0.201, ψ'=0.201", fontsize=25)
plt.ylabel(r'Coeficiente de Lyapunov',fontsize=25)
plt.xlabel(r'Energía ',fontsize=25)
